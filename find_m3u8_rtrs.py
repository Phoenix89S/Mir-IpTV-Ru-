...
CHANNEL_GROUPS = {
    ...
    "Кнопка 19": {
        ...
        "19.26.1": "ТНТ International",
        "19.26.2": "ТНТ4 International",
        #============================================================================
    ...
    "Кнопка 23": {
        ...
        # Сектор: Спутниковые орбиты МАТЕРИНСКОГО Солнца SD (+0 добавлен строго между -1 и +1)
        "23.2": "Солнце -1",
        "23.3": "Солнце +0",
        "23.4": "Солнце +1",
        "23.5": "Солнце +2",
        ...
        # Сектор: Спутниковые орбиты МАТЕРИНСКОГО Солнца HD
        "23.13": "Солнце HD -1",
        "23.14": "Солнце HD +0",
        "23.15": "Солнце HD +1",
        "23.16": "Солнце HD +2",
    ...
    "Кнопка 24": {
        ...
        # Сектор: Спутниковые орбиты МАТЕРИНСКОГО 2х2 SD (+0 добавлен строго между -1 и +1)
        "24.2": "2х2 -1",
        "24.3": "2х2 +0",
        "24.4": "2х2 +1",
        "24.5": "2х2 +2",
        ...
        # Сектор: Спутниковые орбиты МАТЕРИНСКОГО 2х2 HD
        "24.13": "2х2 HD -1",
        "24.14": "2х2 HD +0",
        "24.15": "2х2 HD +1",
        "24.16": "2х2 HD +2",
    ...
    "Кнопка 25": {
        #============================================================================
        # ПРАВИЛО АЛИАСОВ ДЛЯ RU.TV:
        # Основной блок обрабатывает стандартное латинское написание.
        # Хвостовой блок (с позиции 25.24) явно заводит кириллические маркеры "Ру ТВ",
        # исключая любые сбои парсера при распознавании текстовых имен в плейлистах.
        #============================================================================

        # Базовые кнопки основного канала (Латиница)
        "25.0": "RU.TV",
        "25.1": "RU.TV HD",

        # Сектор: Спутниковые орбиты МАТЕРИНСКОГО RU.TV SD (+0 добавлен строго между -1 и +1)
        "25.2": "RU.TV -1",
        "25.3": "RU.TV +0",
        "25.4": "RU.TV +1",
        "25.5": "RU.TV +2",
        ...
        # Сектор: Спутниковые орбиты МАТЕРИНСКОГО RU.TV HD
        "25.13": "RU.TV HD -1",
        "25.14": "RU.TV HD +0",
        "25.15": "RU.TV HD +1",
        "25.16": "RU.TV HD +2",
        ...
        # Хвост: Кириллические базовые маркеры и их спутниковые орбиты
        "25.24": "Ру ТВ",
        # Сектор: Спутниковые орбиты Ру ТВ (SD)
        "25.24.1": "Ру ТВ -1",
        "25.24.2": "Ру ТВ +0",
        "25.24.3": "Ру ТВ +1",
        "25.24.4": "Ру ТВ +2",
        ...
        "25.25": "Ру ТВ HD",
        # Сектор: Спутниковые орбиты Ру ТВ HD
        "25.25.1": "Ру ТВ HD -1",
        "25.25.2": "Ру ТВ HD +0",
        "25.25.3": "Ру ТВ HD +1",
        "25.25.4": "Ру ТВ HD +2",
    ...
    "Кнопка 28": {
        # Базовая кнопка платформы (НЕ ТРОГАЕМ)
        "28.0": "SMOTRIM",

        # Тематическое семейство цифровых каналов «Смотрим» (Логика парных разрешений SD/HD)
        "28.1": "Смотрим 100% Любовь",
        "28.1.1": "Смотрим 100% Любовь",
        "28.1.2": "Смотрим 100% Любовь HD",

        # Кириллический алиас для парсера
        "28.1.3": "Смотрим 100 % Любовь",
        "28.1.4": "Смотрим 100 % Любовь HD",

        "28.2": "Смотрим 100% Факты",
        "28.2.1": "Смотрим 100% Факты",
        "28.2.2": "Смотрим 100% Факты HD",

        # Кириллический алиас для парсера
        "28.2.3": "Смотрим 100 % Факты",
        "28.2.4": "Смотрим 100 % Факты HD",

        "28.3": "Смотрим 100% Классика",
        "28.3.1": "Смотрим 100% Классика",
        "28.3.2": "Смотрим 100% Классика HD",

        # Кириллический алиас для парсера
        "28.3.3": "Смотрим 100 % Классика",
        "28.3.4": "Смотрим 100 % Классика HD",

        "28.4": "Смотрим 100% Мужское",
        "28.4.1": "Смотрим 100% Мужское",
        "28.4.2": "Смотрим 100% Мужское HD",

        # Кириллический алиас для парсера
        "28.4.3": "Смотрим 100 % Мужское",
        "28.4.4": "Смотрим 100 % Мужское HD",

        "28.5": "Смотрим 100% Праздник",
        "28.5.1": "Смотрим 100% Праздник",
        "28.5.2": "Смотрим 100% Праздник HD",

        # Кириллический алиас для парсера
        "28.5.3": "Смотрим 100 % Праздник",
        "28.5.4": "Смотрим 100 % Праздник HD",

        "28.6": "Смотрим 100% Детское",
        "28.6.1": "Смотрим 100% Детское",
        "28.6.2": "Смотрим 100% Детское HD",

        # Кириллический алиас для парсера
        "28.6.3": "Смотрим 100 % Детское",
        "28.6.4": "Смотрим 100 % Детское HD",
    },

    "Кнопка 29": {
        "29.0": "Eurosport 1 Russia SD",
        "29.1": "Eurosport 1 Russia HD",

        "29.2": "Eurosport 2 Russia SD",
        "29.3": "Eurosport 2 Russia HD",

        "29.4": "Euronews Russian SD",
        "29.5": "Euronews Russian HD",
    ...
    "Кнопка 30": {
        ...
        "30.10": "Наш Спорт 6 SD",
        "30.11": "Наш Спорт 6 HD",

        "30.12": "Наш Спорт 7 SD",
        "30.13": "Наш Спорт 7 HD",

        "30.14": "Наш Спорт 8 SD",
        "30.15": "Наш Спорт 8 HD",

        "30.16": "Наш Спорт 9 SD",
        "30.17": "Наш Спорт 9 HD",

        "30.18": "Наш Спорт 10 SD",
        "30.19": "Наш Спорт 10 HD",

        "30.20": "Наш Спорт 11 SD",
        "30.21": "Наш Спорт 11 HD",

        "30.22": "Наш Спорт 12 SD",
        "30.23": "Наш Спорт 12 HD",

        "30.24": "Наш Спорт 13 SD",
        "30.25": "Наш Спорт 13 HD",

        "30.26": "Наш Спорт 14 SD",
        "30.27": "Наш Спорт 14 HD",

        "30.28": "Наш Спорт 15 SD",
        "30.29": "Наш Спорт 15 HD",

        "30.30": "Наш Спорт 16 SD",
        "30.31": "Наш Спорт 16 HD",

        "30.32": "Наш Спорт 17 SD",
        "30.33": "Наш Спорт 17 HD",

        "30.34": "Наш Спорт 18 SD",
        "30.35": "Наш Спорт 18 HD",

        "30.36": "Наш Спорт 19 SD",
        "30.37": "Наш Спорт 19 HD",

        "30.38": "Наш Спорт 20 SD",
        "30.39": "Наш Спорт 20 HD",

        "30.40": "Наш Спорт 21 SD",
        "30.41": "Наш Спорт 21 HD",

        "30.42": "Наш Спорт 22 SD",
        "30.43": "Наш Спорт 22 HD",

        "30.44": "Наш Спорт 23 SD",
        "30.45": "Наш Спорт 23 HD",

        "30.46": "Наш Спорт 24 SD",
        "30.47": "Наш Спорт 24 HD",
    }
}
...
# ==============================================
# Phoenix Germany ©®™:
# «Я сам решаю, какие кнопки эфирные. Автоматика — обслуживает».
#
# Здесь перечисляются ТОЛЬКО те кнопки, которые
# относятся к эфирным каналам. Порядок и состав
# полностью контролируется вручную.
#
# Автоматика:
# - берёт этот список
# - находит кнопки в CHANNEL_GROUPS
# - собирает нормализованные имена каналов
# - формирует ETHERS_CANONICAL
#
# Итог:
# - хочешь эфирку до 28 → вписал 1–28
# - хочешь эфирку до 30 → вписал 1–30
# - хочешь эфирку до 70 → вписал 1–70
# - хочешь эфирку до 100 → вписал 1–100
#
# Код НЕ меняется. Только список.
# Никаких спотыкания. Никаких догадок.
...
ETHERS_BUTTONS = [
    ...
    # Phoenix расширяет словарь → эфирка расширяется вручную:
    "Кнопка 29",
    "Кнопка 30"
]

# Множество нормализованных эфирных имён.
ETHERS_CANONICAL = set()

# Автоматическое построение эфирного канона.
for btn in ETHERS_BUTTONS:
    if btn in CHANNEL_GROUPS:
        for _, name in CHANNEL_GROUPS[btn].items():
            ETHERS_CANONICAL.add(normalize_name(name))

# ==============================================================
#   detect_group_full.py — Каноническая система классификации
#   Автор: Phoenix + Copilot
#   Назначение: определение кнопки, логирование, сборка плейлиста
# ==============================================================
...
# ==============================================================
#   АВТО-ВЫБОР ИМЕНИ ЛОГ-ФАЙЛА logger_n.txt
# ==============================================================
...
def is_clean_match(word: str, name: str) -> bool:
    """
    Проверяет, что совпадение по подстроке — ЧИСТОЕ.
    """
    name = name.lower()
    word = word.lower()
    ...
    right_pos = idx + len(word)
    right_ok = (right_pos == len(name)) or not name[right_pos].isalpha()
...
def looks_like_channel(name: str) -> bool:
    """
    Определяет, похоже ли название на канал, а НЕ на мусор.
    """
    bad = [
        "посмотри", "посмотри-ка", "смотрите", "смотришь",
        "смотримка", "мир посмотри", "отр посмотри"
    ]
...
def is_fake_otr_inside_smotri(name: str) -> bool:
    """
    Если внутри 'смотрим' встречается 'отр' — это НЕ совпадение ОТР.
    """
    n = name.lower()
    return "смотрим" in n and "отр" in n
...
def detect_group(name: str) -> str:
    """
    Определяет, к какой «Кнопке» относится канал.

    Ключевые правила:
    -----------------
    1) Линейка «СМОТРим» — кнопка 28.
       НЕ смешивается с ОТР, НЕ нормализуется.

    2) ОТР — кнопка 9.
       НЕ смешивается со СМОТРим.

    3) 'отр' внутри 'смотрим' — НЕ совпадение.

    4) Эфирные каналы без кнопки → «Общие».

    5) Мусор → «Удаление».

    6) Если совпадений нет → «Общие».
    """
    ...
    log(f"\n=== detect_group('{name}') ===")
    log(f"normalize_name → '{clean}'")

    # ----------------------------------------------------------
    # 0) Специальная логика: СМОТРим
    # ----------------------------------------------------------
    if low.startswith("смотрим") or low.startswith("smotrim"):
        log("→ начинается с 'смотрим' → Кнопка 28")
        return "Кнопка 28"

    # ----------------------------------------------------------
    # 1) Специальная логика: ОТР
    # ----------------------------------------------------------
    if low.startswith("отр"):
        log("→ начинается с 'отр' → Кнопка 9")
        return "Кнопка 9"

    # ----------------------------------------------------------
    # 2) Предохранитель: 'отр' внутри 'смотрим'
    # ----------------------------------------------------------
    if is_fake_otr_inside_smotri(low):
        log("→ 'отр' внутри 'смотрим' → игнорируем совпадение ОТР")

    # ----------------------------------------------------------
    # 3) Кнопки (CHANNEL_GROUPS)
    # ----------------------------------------------------------
    for button, mapping in CHANNEL_GROUPS.items():
        for _, canonical in mapping.items():

            canon = normalize_name(canonical).lower()

            if canon in low and is_clean_match(canon, low):

                if canonical not in WHITELISTS[button]:
                    log(f"Совпадение '{canonical}', но нет в WHITELISTS[{button}] → Общие")
                    return "Общие"

                log(f"Совпадение '{canonical}' → {button}")
                return button

    # ----------------------------------------------------------
    # 4) Эфирные без кнопки → Общие
    # ----------------------------------------------------------
    for ether in ETHERS_CANONICAL:
        e = ether.lower()
        if e in low and is_clean_match(e, low):
            log(f"Эфирный '{ether}', но кнопки нет → Общие")
            return "Общие"

    # ----------------------------------------------------------
    # 5) Мусор
    # ----------------------------------------------------------
    for word in ["отр", "мир", "стс", "матч", "россия", "тнт", "рен"]:
        if word in low and not is_clean_match(word, low):
            if not looks_like_channel(low):
                log(f"Мусор по слову '{word}' → Удаление")
                return "Удаление"

    # ----------------------------------------------------------
    # 6) Общие
    # ----------------------------------------------------------
    log("→ Общие (по умолчанию)")
    return "Общие"



# ==============================================================
#   СБОРКА ПЛЕЙЛИСТА С ЛОГИРОВАНИЕМ
# ==============================================================

def write_playlist(channels: list, output_file: str):
    """
    Формирует итоговый M3U-плейлист и логирует каждый шаг.
    """
    ...
    with open(output_file, "w", encoding="utf-8") as out:
        ...
        for ch in channels:
            ...
            log(f"Плейлист: '{name}' → группа '{group}'")

            if group == "Удаление":
                log(f"Удалён: {name}")
                continue

            out.write(f'#EXTINF:-1 tvg-id="{tvg}" group-title="{group}",{name}\n')
            out.write(url + "\n")
